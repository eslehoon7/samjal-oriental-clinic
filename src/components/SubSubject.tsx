              ...
              <div className="space-y-3 pt-4 border-t border-[#DFD5C6]/30">
                ...
                <ul className="space-y-2.5">
                  {current.benefits.map((bf, i) => (
                    <li key={i} className="flex items-start gap-2 text-xs sm:text-sm font-serif text-[#5C6351]">
                      <span className="w-5 h-5 rounded-full bg-[#C5A059]/10 flex items-center justify-center shrink-0 mt-0.5 border border-[#C5A059]/30">
